...
label = Label( tk, text="RUTUJA (Type X):", font='Times 12 bold', bg='white', fg='black', height=1, width=15)
label.grid(row=1, column=0)


label = Label( tk, text="TANISHQ (Type O):", font='Times 12 bold', bg='white', fg='black', height=1, width=15)
